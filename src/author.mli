...
(** CS 3110 Spring 2021 Final Project
    ...
    @author Jasmine Herrera (jph284)
    @author Alex Popat (asp233)
    @author Daniel Rusk (dgr73)
    @author Quinn Strassburg (qms2) *)
...
(************************************************************ 
   ...
   - Functions [pp_list] and [pp_string] in play.ml are functions we used from A2 where
    Michael Clarkson is the author of them
